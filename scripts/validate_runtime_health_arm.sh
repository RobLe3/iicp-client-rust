...
cargo test --locked --all-features --test runtime_health_fault_injection
cargo test --locked --all-features --lib systemd_notify::tests
...
record = {
    "schema": "iicp.runtime_health_platform_evidence.v1",
    "content_free": True,
    "started_at": started,
